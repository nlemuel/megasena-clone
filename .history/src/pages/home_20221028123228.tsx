        ...
        <>
            ...
            {!isLoading && (
                ...
                <div>
                    <div className="mt-5">
                        <div>
                            <Text description="Resultado" color='#0066b3' fontWeight='normal' fontSize='35px' margin-left='10px' />
                    ...
                    <div className='bolas'>
                        ...
                        <div className='estimativa'>
                            <Text description={`Estimativa de prêmio do próximo concurso ${dataProximoConcurso}`} fontSize='18px' margin="34%" />
                        </div>
                        <div className='valor'>
