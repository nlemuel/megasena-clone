            ...
            {!isLoading && (
                ...
                <div>
                    ...
                    <div className='ml-5 mt-3'>
                        ...
                        <Nums number={dezenasSorteadasOrdemSorteio[1]} />
                        <Nums number={dezenasSorteadasOrdemSorteio[2]} />
                        <Nums number={dezenasSorteadasOrdemSorteio[3]} />
                        <Nums number={dezenasSorteadasOrdemSorteio[4]} />
                        <Nums number={dezenasSorteadasOrdemSorteio[5]} />
                    </div>
