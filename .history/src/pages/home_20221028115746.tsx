        ...
        <>
            ...
            {!isLoading && (
                ...
                <div>
                    <div className="mt-5">
                        <div>
                            <Text description="Resultado" color='#0066b3' fontWeight='normal' fontSize='35px' />
                            <Text description={`Concurso ${numero} (${dataApuracao})`} color='#776d7b' fontSize='25px'  />
                        </div>
                    </div>
                    <hr className='w-75'></hr>

                    <div className='mb-5 mt-5'>
                        <Text description={`Sorteio realizado no ${localSorteio} em ${nomeMunicipioUFSorteio}`} color='#777584' fontSize='18px' margin="35%" />
                    </div>

                    

                    <div className=' border row mt-3'>

                    <div className='ml-5 mt-3' >
                        <Num number={dezenasSorteadasOrdemSorteio[0]} margin="35%" />
                        <Num number={dezenasSorteadasOrdemSorteio[1]} margin="35%"/>
                        <Num number={dezenasSorteadasOrdemSorteio[2]} margin="35%"/>
                        <Num number={dezenasSorteadasOrdemSorteio[3]} margin="35%"/>
                        <Num number={dezenasSorteadasOrdemSorteio[4]} margin="35%"/>
                        <Num number={dezenasSorteadasOrdemSorteio[5]}margin="35%" />
                    </div>

                        <div className='col-4 mt-3'>
                            <Text description={`Estimativa de prêmio do próximo concurso ${dataProximoConcurso}`} fontSize='18px' margin="35%" />
                        </div>
                        <div className='col-5 mt-3'>
                            <Text description={`R$ ${valorEstimadoProximoConcurso},00`} fontSize='35px' color="#344673" fontWeight="bold" margin="35%" />
                        </div>
                    </div>
