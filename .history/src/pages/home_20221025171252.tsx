            ...
            {!isLoading && (
                ...
                <div>
                    ...
                    <div className='ml-5 mt-3'>
                        <Num margin= '100px' number={dezenasSorteadasOrdemSorteio[0]} />
                        <Num margin= '100px' number={dezenasSorteadasOrdemSorteio[1]} />
                        <Num margin= '100px' number={dezenasSorteadasOrdemSorteio[2]} />
                        <Num margin= '100px' number={dezenasSorteadasOrdemSorteio[3]} />
                        <Num margin= '100px' number={dezenasSorteadasOrdemSorteio[4]} />
                        <Num margin= '100px' number={dezenasSorteadasOrdemSorteio[5]} />
                    </div>
