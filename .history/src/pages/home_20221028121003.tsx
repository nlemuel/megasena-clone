        ...
        <>
            ...
            {!isLoading && (
                ...
                <div>
                    ...
                    <div className='sorteio mb-5 mt-5'>
                        <Text description={`Sorteio realizado no ${localSorteio} em ${nomeMunicipioUFSorteio}`} color='#777584' fontSize='18px' margin="33%" />
                    </div>
                    ...
                    <div className='bolas col-4 ml-5 mt-3'>
